    ...
    protected void processTask(final ChunkCompileTaskGenerator generator) throws InterruptedException
    {
        ...
        try
        {
            if (generator.getStatus() != ChunkCompileTaskGenerator.Status.PENDING)
            {
                ...
                {
                    LOGGER.warn("Chunk render behaviour was {} when I expected it to be pending; ignoring behaviour", new Object[] {generator.getStatus()});
                }
        ...
        else
        {
            ...
            try
            {
                if (generator.getStatus() != ChunkCompileTaskGenerator.Status.COMPILING)
                {
                    if (!generator.isFinished())
                    {
                        LOGGER.warn("Chunk render behaviour was {} when I expected it to be compiling; aborting behaviour", new Object[] {generator.getStatus()});
                    }
                ...
                public void onSuccess(@Nullable List<Object> p_onSuccess_1_)
                {
                    ...
                    label21:
                    {
                        try
                        {
                            ...
                            if (!generator.isFinished())
                            {
                                ChunkRenderWorker.LOGGER.warn("Chunk render behaviour was {} when I expected it to be uploading; aborting behaviour", new Object[] {generator.getStatus()});
                            }
                        }
                        finally
                        {
